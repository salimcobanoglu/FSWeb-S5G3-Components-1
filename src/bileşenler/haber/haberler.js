...
//1
const yeniNesne = {
  baslik: "Yeni Eklenen Başlık",
  tarih: "22 Mart 2023",
  ilkParagraf: "Bu yeni eklenen objedir.",
};
...
function haberYapici(obj) {
  ...
  articleH2.textContent = obj.baslik;

  const articleTarih = document.createElement("p");
  articleTarih.classList.add("tarih");
  articleTarih.textContent = obj.tarih;

  const articleP1 = document.createElement("p");
  articleP1.classList.add("paragraf");
  articleP1.textContent = obj.ilkParagraf;

  const articleP2 = document.createElement("p2");
  articleP2.classList.add("paragraf");
  articleP2.textContent = obj.ikinciParagraf;

  const articleP3 = document.createElement("p3");
  articleP3.classList.add("paragraf");
  articleP3.textContent = obj.ucuncuParagraf;
  ...
  articleBox.appendChild(articleH2);
  articleBox.appendChild(articleTarih);
  articleBox.appendChild(articleP1);
  articleBox.appendChild(articleP2);
  articleBox.appendChild(articleP3);
  articleBox.appendChild(buttonOlustur);
